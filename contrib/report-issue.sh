...
# template of information. See https://github.com/helmutkemper/moby/pull/8845

set -e

DOCKER_ISSUE_URL=${DOCKER_ISSUE_URL:-"https://github.com/helmutkemper/moby/issues/new"}
