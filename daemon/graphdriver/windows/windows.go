...
package windows // import "github.com/helmutkemper/moby/daemon/graphdriver/windows"
...
import (
	...
	"github.com/helmutkemper/moby/pkg/longpath"
	...
	if noreexec {
		defer func() {
			if err := winio.DisableProcessPrivileges([]string{winio.SeBackupPrivilege, winio.SeRestorePrivilege}); err != nil {
				...
				// See https://github.com/helmutkemper/moby/pull/28002#discussion_r86259241 for rationale.
